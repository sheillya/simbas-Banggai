$(function () {
    ...
    var options = {
      ...
      series: [
        {
          name: "Statistik Kusioner",
          color: "var(--bs-primary)",
          data: kusionerData,
        },
      ],
      xaxis: {
        type: 'category', // Jenis sumbu x adalah kategori (bulan)
        categories: kusionerData.map(item => item.x), // Mengambil data bulan dari array data
      },
      stroke: {
        curve: "smooth",
        width: 2,
    ...
    new ApexCharts(document.querySelector("#kusioner-stats"), options).render();
    ...
    var options = {
      ...
      xaxis: {
        categories: [["Jan"], ["Feb"], ["Mar"],["Apr"], ["May"], ["June"], ["July"], ["Aug"], ["Sept"], ["Okt"], ["Nov"], ["Des"]],
        axisBorder: {
          show: false,
        },
        axisTicks: {
    ...
    var options = {
      ...
      xaxis: {
        categories: [["Sangat Membantu"], ["Cukup Membantu"], ["Membantu"],["Sedikit Membantu"], ["Tidak Membantu"]],
        axisBorder: {
          show: false,
        },
        axisTicks: {
    ...
    var chart = new ApexCharts(document.querySelector("#persentasejawaban"), options);
    chart.render();
    ...
    var options = {
      series: [
        {
          name: "Jurusan Responden",
          data: [10, 15, 5, 15, 20, 15, 5, 15, 20, 10],
        },
      ],
      ...
      xaxis: {
        categories: [["Teknik", "Informatika"], ["Ilmu" , "Ekonomi"], ["Teknik" , "Industri"],["Sistem","Informasi"], ["Bisnis", "Informasi"],["Manajemen" ,"Informasi"] ,["Manajemen", "Keuangan"] ,["Akuntansi"],["Teknik" , "Telekomunikasi"],["Teknik" ,"Sipil"]],
        axisBorder: {
          show: false,
        },
        labels: {
          rotate: 0, // Mengatur rotasi label kategori menjadi 0 derajat (tidak miring)
    ...
    var chart = new ApexCharts(document.querySelector("#jurusanresponden"), options);
    chart.render();
